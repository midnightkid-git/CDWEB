...
export class DetailItemComponent implements OnInit {
  ...
  constructor(private activateeRoute: ActivatedRoute, private productService: ProductService, private messageService: MessageService) { }
  ...
  addToCart(): void {
    const payload = { productId: this.item.id, size: this.selectedSize.sizeId, quantity: this.selectedSize.quantity };
